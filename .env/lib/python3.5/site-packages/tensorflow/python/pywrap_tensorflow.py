...
def PyRecordReader_New(filename, start_offset, compression_type_string):
    return _pywrap_tensorflow.PyRecordReader_New(filename, start_offset, compression_type_string)
...
def PyRecordWriter_New(filename, compression_type_string):
    return _pywrap_tensorflow.PyRecordWriter_New(filename, compression_type_string)
